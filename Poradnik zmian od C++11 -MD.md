...
> **Przypomnienie:** Literały to dosłowne wartości wpisane bezpośrednio w kodzie.
...
##### Literały przetworzone (cooked) dla liczb

Dla literałów liczbowych, literał przetworzony (cooked literal) ma typ:
